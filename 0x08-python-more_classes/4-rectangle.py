...
class Rectangle:
    ...
    @property
    def width(self):
        """intake of private instance attribute width getter"""
        return self.__width
    ...
    @property
    def height(self):
        """intake for private instance attribute height getter"""
        return self.__height

    @height.setter
    def height(self, value):
        """intake for private instance attribute height setter"""
        if type(value) is not int:
